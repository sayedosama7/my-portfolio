    ...
    <div>
      <Container fluid className='Portfolio text-white text-center fw-bold' id='portfolio'>
        <Row>
          ...
          <Col className='mb-4 wow fadeInUp' data-wow-delay=".1s" md="4">
          ...
          <Col className='mb-4 wow fadeInUp' data-wow-delay=".5s" md="4">
            <div className="projects">
          ...
          <Col className='mb-4 wow fadeInUp' data-wow-delay=".3s" md="4">
            <div className="projects">
