        ...
        <Row>
          <Col md="12">
            ...
            <Form className='w-50 m-auto'>
              ...
              <button type='submit' className='btn btn-primary send m-auto d-block w-100 p-3 wow bounceInUp fw-bold' data-wow-delay="1s" data-wow-duration="1.5s">Send</button>
            </Form>
          </Col>
